...
Across seeds, PCA is consistently worst on support recovery. SparseNoGraph achieves the highest mean support F1, while the Proposed method attains slightly lower F1 but achieves a clearly lower graph smoothness norm on the true chain graph. Shared explained variance is similar across the two sparse methods and lower than PCA, as expected for sparse solutions. This pattern indicates that on chain graphs, graph regularization improves structural coherence while remaining competitive on recovery.
\begin{table}[t]
\centering
\scriptsize
...
\midrule
PCA & 0.261 $\pm$ 0.000 & 2.099 $\pm$ 0.433 & 6.225 $\pm$ 0.363 \\
SparseNoGraph & 0.950 $\pm$ 0.029 & 2.118 $\pm$ 0.426 & 6.092 $\pm$ 0.369 \\
Proposed & 0.927 $\pm$ 0.017 & 1.871 $\pm$ 0.416 & 6.059 $\pm$ 0.372 \\
\bottomrule
\end{tabular}%
}
\end{table}
...
On SBM graphs, PCA again performs worst on support recovery. SparseNoGraph attains substantially higher support F1 than the Proposed method, while the Proposed method is consistently smoother on the true SBM graph (lower normalized graph smoothness). Shared explained variance remains comparable across the two sparse methods. These results show a stable recovery--smoothness tradeoff on SBM: stronger graph regularization improves structural smoothness but can reduce recovery accuracy.
\begin{table}[t]
\centering
\scriptsize
\setlength{\tabcolsep}{3pt}
...
Method & Support F1 & Smoothness (norm) & Shared explained var \\
\midrule
PCA & 0.261 $\pm$ 0.000 & 17.085 $\pm$ 0.871 & 6.225 $\pm$ 0.363 \\
SparseNoGraph & 0.950 $\pm$ 0.029 & 17.166 $\pm$ 0.926 & 6.092 $\pm$ 0.369 \\
Proposed & 0.744 $\pm$ 0.046 & 15.764 $\pm$ 0.988 & 6.003 $\pm$ 0.343 \\
\bottomrule
\end{tabular}%
}
\end{table}
...
\begin{figure}[t]
\centering
\includegraphics[width=\linewidth]{../outputs/sbm_lambda2_sweep/lambda2_panel.png}
