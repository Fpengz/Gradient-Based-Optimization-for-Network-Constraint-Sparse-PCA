...
At $\lambda_2=0.5$ and $\alpha=0.2$ on the chain, rewiring reduces the imposed-graph Laplacian energy from $1.916$ to $1.599$ ($\Delta=-0.317$) while support F1 drops by $0.058$ (mean over seeds $0$--$2$), illustrating that smoothness under a corrupted prior can improve even as true-support recovery worsens.
