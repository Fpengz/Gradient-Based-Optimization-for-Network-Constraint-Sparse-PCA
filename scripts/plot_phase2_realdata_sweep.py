...
DEFAULT_TABLE = ROOT / "results" / "phase2" / "realdata" / "metrics_summary.csv"
DEFAULT_OUT = ROOT / "figures" / "phase2" / "realdata" / "realdata_lambda2_sweep.png"


def write_realdata_plot(df: pd.DataFrame, out_path: Path) -> None:
...
def main() -> None:
    ...
    write_realdata_plot(df, DEFAULT_OUT)
