...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run Phase 2 real-data robustness configs.")
    parser.add_argument("--sanity", action="store_true", help="Run only first 2 configs.")
