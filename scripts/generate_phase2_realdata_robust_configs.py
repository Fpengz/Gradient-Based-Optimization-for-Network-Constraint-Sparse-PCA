...
CONFIG_DIR = ROOT / "configs" / "phase2" / "realdata_robust"
...
def _base_config() -> Dict[str, object]:
    return {
        ...
        "real_subsample_frac": 0.8,
        "graph_family": "real",
        "support_type": "connected",
        "support_size": 0,
        "snr": 0.0,
        "block": "realdata_robust",
    }
...
def generate_realdata_robust_configs() -> None:
    ...
    for seed in SEEDS:
        for lambda2 in LAMBDA2_GRID:
            ...
            config_stem = f"realdata_robust_tcga_brca_lambda2_{tag}_seed{seed}"
            cfg["output_dir"] = (
                f"outputs/phase2/realdata_robust/{config_stem}/seed_{seed}"
            )
...
def main() -> None:
    generate_realdata_robust_configs()
