...
*   **GradFPS (Qiu et al. 2023)**: A convex relaxation using Fantope Projection and Selection solved via proximal gradients.
...
1.  **Algorithm Implementation**: High-performance implementations of Zou-SPCA, GPM, GradFPS, and NC-SPCA.
...
*   Qiu, Y., Lei, J., & Roeder, K. (2023). *Gradient-Based Sparse Principal Component Analysis with Extensions to Online Learning*. Biometrika.
